...
if __name__ == "__main__":
    dataset_val = ImageDataset("/workspace/cogview_dev/zyh/behance_eval_set_v1.2/images/", 512, exts=["jpg"], phase="test")
    val_dataloader = torch.utils.data.DataLoader(dataset_val, batch_size=1, shuffle=False, num_workers=8)

    config = OmegaConf.load("/workspace/cogview_dev/xutd/xu/pytorch-image-tokenizer/configs/sd3.5_c16_ta2_t_14_g_14_d_16_flux.yaml")
